...
using RurayFoodApp2.Models.Transaction;
using RurayFoodApp2.Models;
using Xamarin.Forms;
using Xamarin.Forms.Internals;

namespace RurayFoodApp2.ViewModels.Transaction
{
    /// <summary>
    ...
    public class CheckoutPageViewModel : BaseViewModel
    {
        ...
        public CheckoutPageViewModel()
        {
            this.DeliveryAddress = new ObservableCollection<Customer>
            {
                new Customer
                {
                    CustomerId = 1, CustomerName = "Edwin Daniel", AddressType = "Home", Address = "Sta. Anita #184",
                    MobileNumber = "+51 955 956 335"
                }
            };
            ...
            this.PaymentModes = new ObservableCollection<Payment>
            {
                new Payment
                {
                    PaymentMode = "Pago con tarjeta afiliada", CardNumber = "33** **** **** 9876",
                    CardTypeIcon = "Card.png"
                },
                new Payment
                {
                    PaymentMode="Pago online PayPal"
                }
            };
